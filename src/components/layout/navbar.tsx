        ...
        <>
            ...
            >
                <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <Link
                        href="/"
                        className="ring-focus group flex items-center gap-2.5 rounded-xl"
                    >
                        <span className="relative grid h-9 w-9 place-items-center overflow-hidden rounded-xl bg-aurora-grad text-white shadow-glow">
                        ...
                        <span className="flex flex-col leading-none">
                            <span className="font-display text-base font-extrabold tracking-tight text-[var(--fg)]">
                                {site.name}
                            </span>
